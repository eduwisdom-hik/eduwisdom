...
<head>
    ...
    <title>系统资源--智慧教育资源共享推荐平台</title>
    <script src="<%=basePath%>js/page/companyResource.js"></script>
</head>
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="javascript:void(0);" title="系统资源" class="tip-right"> 教育机构资源 </a>
        </div>
    </div>
                ...
                <div class="widget-box">
                    <div class="widget-content nopadding">
                        <div class="controls controls-row">
                            <input type="text" id="queryCompany" class="span2 m-wrap" placeholder="教育机构名称">
