...
<head>
    ...
    <title>资源浏览记录--智慧教育资源共享推荐平台</title>
    <script src="<%=basePath%>js/page/resourceBrowseRecord.js"></script>
</head>
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="javascript:void(0);" title="资源浏览记录" class="tip-right"> 资源浏览记录 </a>
        </div>
    </div>
